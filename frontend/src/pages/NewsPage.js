  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        {showFilters && (
          <div className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-4 border border-neutral-200 dark:border-neutral-700 mb-4">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-1">
                <span className="text-sm text-success-600 dark:text-success-400 font-medium">{t('positive')}</span>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <span className="text-sm text-neutral-600 dark:text-neutral-400 font-medium">{t('neutral')}</span>
                <span className="text-sm text-neutral-500 dark:text-neutral-400">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <span className="text-sm text-danger-600 dark:text-danger-400 font-medium">{t('negative')}</span>
                <span className="text-sm text-neutral-500 dark:text-neutral-400">
              ...
              {sentimentTrends.topStocks.slice(0, 3).map((stock, index) => (
                <div key={index} className="flex items-center">
                  ...
                  <div className="ml-auto flex items-center">
                    ...
                    <FiTrendingUp className="text-success-500" />
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="card p-6 md:col-span-2">
          ...
          <div className="h-64 flex items-center justify-center">
            <div className="text-neutral-500 dark:text-neutral-400 text-center">
              <FiBarChart2 className="h-12 w-12 mx-auto mb-2 opacity-50" />
              <p>{t('sentiment_chart_placeholder')}</p>
            </div>
          </div>
            ...
            {sentimentTrends.sectors.slice(0, 6).map((sector, index) => (
              <div key={index} className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-3">
                ...
                <div className="flex items-center">
                  <div
                    className={`w-2 h-2 rounded-full mr-1 ${sector.positive > 50 ? 'bg-success-500' : sector.negative > 30 ? 'bg-danger-500' : 'bg-neutral-500'}`}
                  ></div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          {filteredNews.length > 0 ? (
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <a
                      ...
                      className="text-lg font-medium text-neutral-900 dark:text-neutral-100 hover:text-primary-600 dark:hover:text-primary-400 flex items-start"
                    >
                      <span>{news.title}</span>
                      <FiExternalLink className="ml-2 h-4 w-4 flex-shrink-0 mt-1" />
                    </a>
                    
                    <div className="flex flex-wrap items-center mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                      ...
                      <span className="mx-1">•</span>
                      <span
                        className="px-2 py-0.5 rounded-full text-xs bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200"
                      >
                        {t(news.category)}
                      </span>
                    </div>
                      ...
                      <div className="mr-auto">
                        ...
                        {news.relatedStocks.map((stock, index) => (
                          <Link
                            key={index}
                            to={`/stock/${stock.symbol}`}
                            className="inline-block px-2 py-1 bg-neutral-100 dark:bg-neutral-800 rounded text-xs text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-700 mr-1 mb-1"
                          >
                            {stock.name}
                          </Link>
                        ))}
            ...
            <div className="text-center py-12 border border-neutral-200 dark:border-neutral-700 rounded-lg">
              <FiFileText className="h-12 w-12 mx-auto text-neutral-400 dark:text-neutral-600 mb-4" />
      ...
      <div className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-4 border border-neutral-200 dark:border-neutral-700">
        <h4 className="font-medium text-neutral-900 dark:text-neutral-100 mb-2 flex items-center">
          <FiInfo className="mr-2 h-4 w-4 text-warning-500" />
          {t('disclaimer')}
        </h4>
